...
Config.Language = {
  [1] = {text="Armurerie"},
  [2] = {text="Vous n'avez pas d'argent."},
  [3] = {text="Vous achetez de l'équipement pour :"},
  [4] = {text="Vous achetez des armes pour :"},
  [5] = {text="Vous avez trop d'armes."},
  [6] = {text="Vous avez trop de munition."},
  [7] = {text="Vous avez rechargé votre arme."},
  [8] = {text="Vous n'avez pas la bonne arme de selectionné."},
  [9] = {text="Accepter"},
  [10] = {text="De combien en avez vous besoin?"},
  [11] = {text="Ouvrir magasin"},
  [12] = {text="Ouvrir l'atelier"},  
  [13] = {text="Quelqu'un est proche."},
  [14] = {text="viseur"},--Command for put down scope (only for buyed scopes)
  [15] = {text="Vous avez des munitions pour : "},
  [16] = {text="Votre arme est pleine, vous récupérez la boîte : "},
  [17] = {text="Vous avez moins de 50 % de munitions, vous rechargez votre arme."}
}
