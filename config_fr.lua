...
Config.Language = {
  ...
  [3] = {text="Vous achetez de l'équipement pour votre "},
  [4] = {text="Vous achetez un(e) "},
  [5] = {text="Vous avez trop d'armes."},
  [6] = {text="Vous avez trop de munitions."},
  [7] = {text="Vous avez rechargé votre arme."},
  [8] = {text="Vous n'avez pas la bonne arme sélectionnée."},
  [9] = {text="Accepter"},
  [10] = {text="De combien en avez-vous besoin ?"},
  [11] = {text="Ouvrir le magasin"},
  [12] = {text="Ouvrir l'atelier"},
  [13] = {text="Quelqu'un est proche."},
  [14] = {text="Viseur"},--Command for put down scope (only for buyed scopes)
  [15] = {text="Vous achetez des munitions pour "},
  [16] = {text="Votre arme est pleine, vous récupérez la boîte de "},
...
Config.LanguageWeapons = {
  ...
  [4] = "Matériel du cadre",
  [5] = "Mire",
  [6] = "Couleur de la gachette",
  [7] = "Poignée",
  [8] = "Gravure du cadre",
  [9] = "Couleur de la mire",
  [10] = "Habillage",
  [11] = "Gravure du canon",
  [12] = "Couleur gravure du cadre",
  [13] = "Matériel du canon",
  [14] = "Gravure sur le canon",
  [15] = "Couleur des gravures du canon",
  [16] = "Matériel du cylindre",
  [17] = "Gravure du cylindre",
  [18] = "Couleur des gravures du cylindre",
  [19] = "Matériel du manche",
  [20] = "Gravure sur la poignée",
  [21] = "Rayure du canon",
  [22] = "Matériel de protection",
  [23] = "Couleur des protections",
  [24] = "Bande",
  [25] = "Couleur des bandes",
  [26] = "Lunette",
  [27] = "STOCK",
  [28] = "Couleur de vernis",
  [29] = "Couleur du cuir",
  [30] = "Couleur de la corde",
  [31] = "Ligne de pêche",
  [32] = "Matériel de la lame",
  [33] = "Gravure sur la lame",
  [34] = "Couleur des gravures de la lame",
  [35] = "Teinte d'origine de la poignée",
}
...
Config.priceTable = {
   ...
   [Config.LanguageWeapons[35]] = 0.20,
}
